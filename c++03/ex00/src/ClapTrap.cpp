...
/*   Updated: 2024/06/22 01:20:24 by yshimoma         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap(const ClapTrap& other)
    ...
    std::cout << this->_name << " is Copy constructor created" << std::endl;
}

ClapTrap& ClapTrap::operator=(const ClapTrap& other) {
    std::cout << this->_name << " is Copy assignment operator called"
              << std::endl;
    if (this != &other) {
