...
Character::Character() : _name("") {
    ...
    std::cout << RED_START << "Character: Default constructor" << COLOR_END
              << std::endl;
}
...
Character::Character(const std::string& name) : _name(name) {
    ...
    std::cout << RED_START
              << "Character: constructor called with name: " << name
              << COLOR_END << std::endl;
}
...
Character::Character(Character& other) : _name(other._name) {
    ...
    std::cout << RED_START << "Character: Copy constructor" << COLOR_END
              << std::endl;
}
...
Character& Character::operator=(const Character& other) {
    ...
    std::cout << RED_START << "Character: Copy assignment" << COLOR_END
              << std::endl;
    return *this;
}
